      ...
      {!compact && (
        <>
          ...
          <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 p-5 text-center">
            <p className="text-sm font-black text-slate-800">Photo upload placeholder</p>
            <p className="mt-1 text-xs font-semibold text-slate-500">Connect this to Netlify Forms, Formspree, or Jotform to accept images.</p>
          </div>
        </>
      )}
